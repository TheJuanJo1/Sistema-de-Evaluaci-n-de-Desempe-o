                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 md:ml-2">Nuevo Periodo</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="text-3xl font-bold text-slate-800 tracking-tight">Crear Nuevo Periodo</h2>
        </div>
    </x-slot>

    <div class="max-w-3xl">
        <form action="{{ route('periods.store') }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            @csrf
            ...
            <div class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full border-slate-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl" type="text" name="name" :value="old('name')" required autofocus placeholder="Ej. Primer Semestre 2024" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="start_date" class="block mt-1 w-full border-slate-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl" type="date" name="start_date" :value="old('start_date')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="end_date" class="block mt-1 w-full border-slate-200 focus:border-blue-500 focus:ring-blue-500 rounded-xl" type="date" name="end_date" :value="old('end_date')" required />
                ...
                <div class="block mt-4">
                    <label for="is_active" class="inline-flex items-center cursor-pointer">
                        <div class="relative">
                            <input id="is_active" name="is_active" type="checkbox" class="sr-only peer" {{ old('is_active') ? 'checked' : '' }}>
                            <div class="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </div>
                        <span class="ml-3 text-sm font-semibold text-slate-700">Activar este periodo inmediatamente</span>
                    </label>
                    <p class="text-xs text-slate-400 mt-2 ml-14">Nota: Solo puede haber un periodo activo a la vez. Al activar este, los demás se cerrarán.</p>
                </div>
            </div>
