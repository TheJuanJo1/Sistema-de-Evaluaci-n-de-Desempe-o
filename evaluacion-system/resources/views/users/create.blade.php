            ...
            <div class="p-8 md:p-10">
                <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full bg-slate-50 border-slate-200 rounded-xl focus:ring-blue-500 transition duration-200" type="text" name="name" :value="old('name')" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-1 w-full bg-slate-50 border-slate-200 rounded-xl focus:ring-blue-500 transition duration-200" type="email" name="email" :value="old('email')" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Password -->
                        <div>
                            <x-input-label for="password" value="Contraseña" class="font-bold text-slate-700 uppercase text-[10px] tracking-widest mb-2" />
                            <x-text-input id="password" class="block mt-1 w-full bg-slate-50 border-slate-200 rounded-xl focus:ring-blue-500 transition duration-200" type="password" name="password" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="password_confirmation" class="block mt-1 w-full bg-slate-50 border-slate-200 rounded-xl focus:ring-blue-500 transition duration-200" type="password" name="password_confirmation" required />
