                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 md:ml-2">Seguimiento</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="text-3xl font-bold text-slate-800 tracking-tight">Seguimiento de Mejora</h2>
            <p class="text-slate-500 mt-1">Trabajador: <span class="font-semibold text-slate-700">{{ $evaluation->worker->name }}</span> | Periodo: <span class="font-semibold text-slate-700">{{ $evaluation->period->name }}</span></p>
        </div>
    </x-slot>

    <div class="py-2">
        <livewire:improvement-plan-follow-up :evaluation="$evaluation" />
    </div>
</x-app-layout>
